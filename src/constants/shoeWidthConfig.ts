...
export const TONNAGE_RANGES: TonnageRangeConfig[] = [
  ...
  { range: '20 - 23', models: ['ZX200-5B', 'ZX200-6', 'ZX200LC-6', 'ZX200X-5B', 'ZX210LC-6', 'ZX210K-5B', 'ZX210K-6', 'ZX210H-6', 'ZX210LCH-5B', 'ZX210LCK-6', 'ZX225US-5B', 'ZX225US-6', 'ZX225USR-5B', 'ZX225USR-6', 'ZX225USRK-5B'], cabin: 'CABINA CERRADA/AC', armType: 'ESTANDAR', shoeWidthOptions: [600, 800], blade: null, pip: null },
