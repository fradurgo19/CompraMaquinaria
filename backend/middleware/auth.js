...
// Puede editar equipos: comerciales (solo estado), jefe_comercial, gerencia, admin
export const canEditEquipments = requireRole('comerciales', 'jefe_comercial', 'gerencia', 'admin');
