  ...
  try {
    ...
    const result = await pool.query(`
      SELECT 
        ...
        COALESCE(p.purchase_type, CASE WHEN p.auction_id IS NOT NULL THEN 'SUBASTA' ELSE 'STOCK' END) as tipo,
        COALESCE(p.purchase_type, CASE WHEN p.auction_id IS NOT NULL THEN 'SUBASTA' ELSE 'STOCK' END) as purchase_type,
