-- Migration: Ensure default machine specifications are inserted
-- Created: 2025-12-30
-- Description: Insert or update all default machine specifications
-- This migration ensures all specifications from local are in Supabase

-- Insertar especificaciones por defecto de máquinas
-- Usar ON CONFLICT para actualizar si ya existen

INSERT INTO public.machine_spec_defaults (brand, model, capacidad, spec_blade, spec_pip, spec_cabin, shoe_width_mm, arm_type)
VALUES
